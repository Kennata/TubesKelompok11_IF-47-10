...
func TambahDataPinjamBuku(Pinjam *DataPinjam, nPinjam *int) {
	...
	for x != 0 {
		...
		for ada != -1 {
			...
			fmt.Println("-------------------------------------------------------------------")
			fmt.Println("PETUNJUK:")
			fmt.Println("Gunakan tanda '_' sebagai pengganti spasi saat memasukkan nama.")
			...
			for duplikat == true {
				...
				fmt.Println("---------------------------------------------------------")
				fmt.Println("PETUNJUK:")
				fmt.Println("Gunakan '_' sebagai pengganti spasi saat memasukkan nama.")
				fmt.Println("Untuk kembali, masukkan 0 ke bagian ID buku.")
				fmt.Println("---------------------------------------------------------")
				fmt.Println("ID dan nama peminjam buku:")
				fmt.Scan(&ID)
...
func PencarianBuku(Book Buku, nBuku int) {
	...
	for x != "Back" {
		...
		fmt.Println("Gunakan '_' sebagai pengganti spasi saat memasukkan judul.")
		fmt.Println("---------------------------------------------------------")
